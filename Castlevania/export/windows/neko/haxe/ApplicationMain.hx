...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Glyn && Alexander", "Castlevania", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Castlevania", null, { width: 640, height: 480 });
